        ...
        <table> 
            ...
            <tbody> 
                <tr class="grey"> 
                    ...
                    <td> 
                        <a href="###"><img src="<?php echo base_url()?>resource/gfx/icon-edit.png" alt="Edit this item" /></a> 
                        <a href="###"><img src="<?php echo base_url()?>resource/gfx/icon-delete.png" alt="Delete this item" /></a> 
                    </td> 
                </tr> 
                <tr> 
                    <td><input type="checkbox" /></td> 
...
<div class="box medium"> 
    ...
    <div class="content thumbs"> 
        ...
        <div class="thumb"> 
            <div><a href="###"></a></div> 
            <img src="<?php echo resource_url('gfx/photo/photo-1.jpg') ?>" alt="" /> 
        </div> 
        
        <div class="thumb"> 
            <div><a href="###"></a></div> 
            <img src="<?php echo resource_url('gfx/photo/photo-2.jpg') ?>" alt="" /> 
        </div> 
        
        <div class="thumb"> 
            <div><a href="###"></a></div> 
            <img src="<?php echo resource_url('gfx/photo/photo-3.jpg') ?>" alt="" /> 
        </div> 
        
        <div class="thumb"> 
            <div><a href="###"></a></div> 
            <img src="<?php echo resource_url('gfx/photo/photo-4.jpg') ?>" alt="" /> 
        </div> 
        
        <div class="thumb"> 
            <div><a href="###"></a></div> 
            <img src="<?php echo resource_url('gfx/photo/photo-5.jpg') ?>" alt="" /> 
        </div> 
        
        <div class="thumb"> 
            <div><a href="###"></a></div> 
            <img src="<?php echo resource_url('gfx/photo/photo-6.jpg') ?>" alt="" /> 
        </div> 
        
        <div class="thumb"> 
            <div><a href="###"></a></div> 
            <img src="<?php echo resource_url('gfx/photo/photo-7.jpg') ?>" alt="" /> 
        </div> 
        
        <div class="thumb"> 
            <div><a href="###"></a></div> 
            <img src="<?php echo resource_url('gfx/photo/photo-8.jpg') ?>" alt="" /> 
        </div> 
    ...
    <div class="content tabs"> 
        ...
        <div id="tab2" class="tabdiv"> 
            <table> 
                <tr> 
                    <td> 
                        <img src="<?php echo resource_url('gfx/photo/photo-2.jpg') ?>" class="thumb" align="right" alt="" /> 
                        Class aptent taciti sociosqu ad litora torquent per conubia nostra, per incept
                        himenaeos. Mauris ultricies laoreet felis in rhoncus. Sed egestas lorem ferm
                        entum felis lacinia molestie. Pellentesque lobortis turpis nunc. Nam nec
                        adipiscing magna.<br /> 
        ...
        <div id="tab3" class="tabdiv"> 
            <table> 
                <tr> 
                    <td> 
                        <img src="<?php echo resource_url('gfx/photo/photo-5.jpg') ?>" class="thumb" align="right" alt="" /> 
                        Class aptent taciti sociosqu ad litora torquent per conubia nostra, per incept
                        himenaeos. Mauris ultricies laoreet felis in rhoncus. Sed egestas lorem ferm
                        entum felis lacinia molestie. Pellentesque lobortis turpis nunc. Nam nec
                        adipiscing magna.<br /> 
